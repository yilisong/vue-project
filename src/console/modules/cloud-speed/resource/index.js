...
const resources = {
  SourceSpeedResource: axios.create({
    baseURL: BASE_URL
  }),
  ConsoleTabPerformResource: axios.create({
    baseURL: BASE_URL
  }),
  SourceSpeedCommonResource: axios.create({
    baseURL: BASE_URL
  })
}
...
export const {
  SourceSpeedResource,
  ConsoleTabPerformResource,
  SourceSpeedCommonResource
} = resources
